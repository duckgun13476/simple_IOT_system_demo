...
"""
@timer
def calculate_temperature_change(arr,wall, different_neighbours, speed=1.0, thermal_d=0.024,cement_d=7.246376811594202e-07,
...
arr = np.random.randint(20, 21, size=(12, 12, 12))
...
for i in range(10):
    ...
    # print(arr_diff)
    arr_step_1 = calculate_temperature_change(arr,wall ,arr_diff)
